// To parse this data:
//
//   import { Convert, Personajes } from "./file";
//
//   const personajes = Convert.toPersonajes(json);
//
...
export class Convert {
    public static toPersonajes(json: string): Personajes {
        return cast(JSON.parse(json), r("Personajes"));
    }

    public static personajesToJson(value: Personajes): string {
        return JSON.stringify(uncast(value, r("Personajes")), null, 2);
    }
}
